...
int front1(); //admin system login
void front2(); //welcome page
int overs();
void menu(); //user manual and instructions
void show(); //creating txt files
int error(int, int * ); //checking incorrect inputs
...
int main() {
  ...
  while (1) {
    ...
    case '1': {
      ...
      printf("=========================================================\n");
      printf("BOWLER'S NAME              RUNS                WICKETS\n");
      printf("=========================================================\n");
      for (i = 0; i < over; i++) {
